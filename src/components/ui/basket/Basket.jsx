...
import {getCartTotal, removeFromCart, setOpen} from "../../../redux/slices/cartSlice";
import {NavLink} from "react-router-dom";

function Basket() {
    const dispatch = useDispatch();
    const {open, cart, totalAmount} = useSelector(state => state.cart);
    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            <Dialog as="div" className="relative z-10" onClose={closeBasket}>
                <Transition.Child
                    as={Fragment}
                                    ...
                                    <div
                                        ...
                                        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                            ...
                                            <p className="mt-0.5 text-sm text-gray-500">Shipping and taxes
                                                ...
                                                checkout.</p>
                                            <div className="mt-6">
                                                <NavLink to={"/cart"} onClick={() => closeBasket()}
